...
```{r}
tsls_d <- ivreg(log_volume_sold_kg ~ log_price_euro_kg | wind_m_s +
                as.factor(country) +
                as.factor(year) +
                as.factor(month),
                data = sardines)
